...
import com.example.andrclass.R;
...
public class ByteImageAdapter extends BaseAdapter{
	...
	private static class ByteImageDownloader implements Runnable{
		...
		public ByteImageDownloader(ImageView iv, ByteImage[] images,  int posiiton){
			this.images = images;
		...
		public void run() {
			...
			Log.e("image error", "error ocurred downloading the image");
		}
		}
